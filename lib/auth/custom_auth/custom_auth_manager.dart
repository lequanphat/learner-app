...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    learnSMARTRAuthUserSubject.add(
      LearnSMARTRAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<LearnSMARTRAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  LearnSMARTRAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = LearnSMARTRAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    learnSMARTRAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
LearnSMARTRAuthUser? currentUser;
